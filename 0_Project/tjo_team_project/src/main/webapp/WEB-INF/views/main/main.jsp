	...
	<div class="dad">
		...
		<section>
			<div class="poster">
				...
				<div class="pic">
					<!-- ## list를 그대로 받아서 쓰는 방법. ##-->
					<img src="${ list.get(0).posterList.get(0)}" id="poster-big1" alt="포스터1"> <span
				...
				<div class="pic">
					<!-- Vo로 한 번 걸러서 쓰는 방법 -->
					<img src="${ new_Vo_3.posterList.get(0) }" id="poster-small1" alt="포스터2"> <span
						class="pic-caption bottom-to-top">
				...
				<div class="pic">
					<img src="${ new_Vo_4.posterList.get(0) }" id="poster-small2" alt="포스터3"> <span
						class="pic-caption bottom-to-top">
						<h1 class="pic-title">${ movieVo.title }</h1>
						<p>
							${ movieVo.genre }<br>
				...
				<div class="pic">
					<img src="${ new_Vo_5.posterList.get(0) }" id="poster-small3" alt="포스터4"> <span
						class="pic-caption bottom-to-top">
						<h1 class="pic-title">${ movieVo.title }</h1>
						<p>
							${ movieVo.genre }<br>
				...
				<div class="pic">
					<img src="${ new_Vo_6.posterList.get(0) }" id="poster-small4" alt="포스터5">
