...
<!-- CSS 초기화 -->
<link rel="stylesheet"
	href="${ pageContext.request.contextPath }/resources/css/w_init.css">
<link rel="stylesheet"
...
<!-- 웹 폰트 -->
<link rel="stylesheet"
	href="https://fonts.googleapis.com/css?family=Noto+Sans+KR:199,300,400,500,700,900&subset=korean">
</head>
			...
			<div class="menu_nav">
				<ul class="list_menu_nav">
					<li class="link_list_menu_nav"><a href="#"
						onclick="location.href='${ pageContext.request.contextPath }/notice/notice.do';">Notice</a></li>
