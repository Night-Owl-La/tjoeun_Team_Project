...
public class BookingVo {
	...
	public BookingVo(int bk_idx, int user_idx, String bk_regdate, String bk_ticket_count, String bk_saet_location,
			String bk_select_date, String bk_select_location, String bk_select_time, String docid) {
		super();
		this.bk_idx = bk_idx;
